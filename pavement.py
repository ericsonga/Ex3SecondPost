...
serving_dir = "./build/Ex3SecondPost"
dest = '../../static'
project_name = "Ex3SecondPost"

options(
    sphinx = Bunch(docroot=".",),

    build = Bunch(
        builddir="./build/Ex3SecondPost",
        sourcedir="_sources",
        outdir="./build/Ex3SecondPost",
        confdir=".",
        project_name = "Ex3",
        template_args={'course_id': 'Ex3SecondPost',
                       'login_required':'true',
                       'appname':master_app,
                       'loglevel': 10,
